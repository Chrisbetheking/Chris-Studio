...
settings: {
  ...
  safety: {
    ...
    inspectorDesc: 'Real-time scan results for your prompt',
    receipt: 'Safety Receipt',
    receiptDesc: 'What was detected, redacted, and sent',
    noFindings: 'No sensitive content detected',
    findingsFound: '{count} finding(s) detected',
    riskSafe: 'Safe',
    riskLow: 'Low Risk',
    riskMedium: 'Medium Risk',
    riskHigh: 'High Risk',
    criticalBlocked: 'Critical content blocked',
    criticalBlockedDesc: 'This message contains high-risk content and was blocked from sending.',
    blockedApiKey: 'API key detected',
    blockedToken: 'Access token detected',
    blockedDbUrl: 'Database URL detected',
    ...
    sendAnyway: 'Send Anyway (not recommended)',
    blockAndReview: 'Block & Review',
    scanResult: 'Scan Result',
  },
  history: {
    title: 'History',
    subtitle: 'Browse past conversations and safety receipts',
    search: 'Search conversations...',
    noConversations: 'No conversations yet',
    noConversationsDesc: 'Start a chat to see your history here',
    today: 'Today',
    yesterday: 'Yesterday',
    thisWeek: 'This Week',
    older: 'Older',
    ...
    clearAllConfirm: 'Delete all conversation history? This cannot be undone.',
    filterAll: 'All',
    filterSafe: 'Safe',
