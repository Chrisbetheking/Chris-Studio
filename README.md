...
- [Windows Portable ZIP](https://github.com/Chrisbetheking/tokenfence-studio/releases/download/v1.0.16/TokenFence-Studio-Windows-v1.0.16-portable.zip)
...
Download `TokenFence-Studio-Windows-v1.0.16-portable.zip`, extract it first, then run `tokenfence-studio.exe` from the extracted folder.
