...
**Languages:** [English](README.md) | [????(README.zh-CN.md)
...
- [Windows Portable ZIP](https://github.com/Chrisbetheking/tokenfence-studio/releases/download/v1.0.10/TokenFence-Studio-Windows-v1.0.10-portable.zip)
...
[Releases](https://github.com/Chrisbetheking/tokenfence-studio/releases) | [Update Log](CHANGELOG.md) | [????(README.zh-CN.md)
...
| Projects | Project workspace entry | Working |
| Settings | Configuration entry | Working |
...
Download `TokenFence-Studio-Windows-v1.0.10-portable.zip`, extract it first, then run `tokenfence-studio.exe` from the extracted folder.
