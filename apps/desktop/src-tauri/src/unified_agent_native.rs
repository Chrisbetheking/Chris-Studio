...
#[cfg(target_os = "macos")]
fn run_jxa(script: &str, app: Option<&str>, index: Option<usize>) -> Result<String, String> {
...
pub fn computer_inspect_accessibility(app: Option<String>) -> AccessibilitySnapshot {
    ...
    #[cfg(target_os = "macos")]
    {
        return match run_jxa(INSPECT_SCRIPT, app.as_deref(), None) {
...
pub fn computer_activate_accessibility(
    ...
    #[cfg(target_os = "macos")]
    {
        return match run_jxa(ACTIVATE_SCRIPT, app.as_deref(), Some(index)) {
