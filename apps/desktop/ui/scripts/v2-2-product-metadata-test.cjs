...
assert.equal(synchronizeAppText('<small>v2.3.0-alpha.4 · macOS</small>', '2.4.0-alpha.1'), '<small>v2.4.0-alpha.1 · macOS</small>');
assert.equal(
  synchronizeAboutVersion("const fallback: PlatformInfo = { appVersion: '2.3.0-alpha.4', os: 'Loading…' };", '2.4.0-alpha.1'),
  "const fallback: PlatformInfo = { appVersion: '2.4.0-alpha.1', os: 'Loading…' };",
);
