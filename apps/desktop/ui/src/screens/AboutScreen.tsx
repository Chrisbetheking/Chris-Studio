  ...
  return (
    <div>
      ...
      <div className="stats-grid">
        <div className="stat-card"><div className="stat-label">Version</div><div className="stat-value" style={{fontSize:20}}>v1.6.0</div></div>
      ...
      <div className="card">
        ...
        <div className="section-list">
          ...
          <div className="section-item"><div className="section-item-title">License</div><div className="section-item-desc">MIT</div></div>
